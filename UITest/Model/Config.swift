    ...
    public struct Controls: CustomDefaultProtocol {
        ...
        public struct AlertViewController: CustomDefaultProtocol {
            public static func initialize() {
                ...
                UIX3AlertViewController.Defaults.AlertView.Color.background = Config.Colors.background
                ...
                UIX3AlertViewController.Defaults.AlertView.height = 12.0
                UIX3AlertViewController.Defaults.AlertView.width = 280.0
